...
void MioSolver::risolvi(int nodoStart){	
//  ------- 	AVVIA IL SOLVER PER TROVARE LA SOLUZIONE
	...
	try{
		...
		cout << " Valore funzione obiettivo per MioSolver: " << valoreFO << " [start: "<< migliorStart <<"]"<< endl;			// stampa il valore della funzione obiettivo per la soluzione ottima
